                        ...
                        <div className="k-treelist k-grid k-grid-md k-grid-display-block">
                            <div className="k-table-thead k-grid-header">
                                <div className="k-grid-header-wrap">
                                    <table className="k-table k-table-md" style={{ minWidth: "250px" }}>
                                        <colgroup>
                                            <col style={{ width: '50px' }} />
                                            <col />
                                        </colgroup>
                                        <thead className="k-table-head">
                            ...
                            <div className="k-grid-content k-auto-scrollable" style={{ height: "530px", display: "block" }}>
                                <table className="k-table k-table-md k-selectable" style={{ minWidth: "250px" }}>
                                    <colgroup>
                                        <col style={{ width: '50px' }} />
                                        <col />
                                    </colgroup>
                    ...
                    <div className="k-gantt-timeline">
                        <div className="k-timeline k-grid k-grid-md">
                            <div className="k-grid-header">
                                <div className="k-grid-header-wrap">
                                    <table className="k-table k-table-md" style={{ width: "4200px" }}>
                                        <colgroup>
                            ...
                            <div className="k-grid-content" style={{ height: "530px" }}>
                                <div className="k-gantt-tables">
                                    <table className="k-table k-table-md k-gantt-rows" style={{ width: "4200px" }}>
                                        <colgroup>
                                            <col />
                                        </colgroup>
                                        <tbody className="k-table-tbody">
