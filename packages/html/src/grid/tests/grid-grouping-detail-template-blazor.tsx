                                ...
                                <table role="grid" className="k-table k-table-md k-grid-table" style={{ height: 'auto' }}>
                                    ...
                                    <tbody className="k-table-tbody">
                                        ...
                                        <tr className="k-table-row k-detail-row">
                                            ...
                                            <td className="k-table-td k-detail-cell" colSpan={4}>
                                                Template Text
                                            </td>
                                        </tr>
                                        <tr role="row" className="k-table-row k-table-group-row k-grouping-row">
                                        ...
                                        <tr className="k-table-row k-table-alt-row k-master-row k-alt k-expanded">
                                            <td className="k-table-td k-table-group-td k-group-cell"></td>
                                            <td className="k-table-td k-table-group-td k-group-cell"></td>
                                            <td className="k-table-td k-hierarchy-cell">
                                                <Icon name="minus" />
                                        ...
                                        <tr className="k-table-row k-table-alt-row k-detail-row k-alt">
                                            <td className="k-table-td k-table-group-td k-group-cell"></td>
                                            <td className="k-table-td k-table-group-td k-group-cell"></td>
                                            <td className="k-table-td k-hierarchy-cell"></td>
                                            <td className="k-table-td k-detail-cell" colSpan={4}>
