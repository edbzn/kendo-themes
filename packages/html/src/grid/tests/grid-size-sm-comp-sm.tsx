        ...
        <div id="test-area" className="k-d-grid k-grid-cols-2">
            ...
            <section className="col-2">
                <div className="k-grid k-grid-sm k-grid-no-scrollbar">
                    ...
                    <div className="k-widget k-pager k-pager-sm k-grid-pager">
            ...
            <section className="col-2">
                <div className="k-grid k-grid-sm k-grid-no-scrollbar">
                    <div className="k-toolbar k-toolbar-sm k-grid-toolbar">
                    ...
                    <div className="k-grid-content">
                        <table className="k-table k-table-sm" style={{ height: 'auto' }}>
                            <colgroup>
                                <col /><col /><col /><col style={{ width: "300px" }} />
                            </colgroup>
                            <tbody className="k-table-tbody">
                ...
                <div className="k-grid k-grid-sm k-grid-no-scrollbar">
                    <div className="k-grouping-header">
                        ...
                        <div className="k-group-indicator">
                            ...
                            <Button size="small" fillMode="flat" icon="close"></Button>
                        </div>
                        <div className="k-group-indicator">
