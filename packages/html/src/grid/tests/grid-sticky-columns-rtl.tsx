            ...
            <div className="k-grid k-grid-md k-rtl" role="grid" style={{ height: "700px", width: "500px" }}>
                <div className="k-grouping-header k-grouping-header-flex">
                    <div className="k-indicator-container" style={{ touchAction: "none" }}>
                        <div className="k-group-indicator">
                            <a className="k-link" href="#"><Icon name="sort-asc-small" />shipName</a>
                ...
                <div className="k-grid-header">
                    <div className="k-grid-header-wrap" style={{ borderWidth: '0px' }}>
                        <table className="k-table k-table-md" style={{ width: "1434px" }}>
                            <colgroup>
                                <col width="32px" />
                                <col width="32px" />
                                <col width="200px" />
                            ...
                            <thead className="k-table-thead">
                                <tr role="row" style={{ touchAction: "none" }}>
                                    <th colSpan={1} rowSpan={1} className="k-table-th k-header" style={{ left: '0px', right: '0px' }}><a className="k-link"> </a></th>
                                    <th colSpan={1} rowSpan={1} className="k-table-th k-header k-hierarchy-cell" style={{ left: '0px', right: '0px' }}><a className="k-link"> </a></th>
                        ...
                        <div style={{ position: "relative" }}>
                            <table className="k-table k-table-md k-grid-table" style={{ width: "1434px" }}>
                                ...
                                <tbody className="k-table-tbody">
                                    <tr className="k-table-group-row k-grouping-row" role="row">
