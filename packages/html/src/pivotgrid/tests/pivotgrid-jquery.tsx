                        ...
                        <tr>
                            <td>
                                <div className="k-pivot-rowheaders" style={{ width: "163px" }}>
                                    <Toolbar className="k-pivot-toolbar k-settings-measures k-pivot-setting" resizable={false} style={{ height: "72px" }}>
                                        <Chip
                                    ...
                                    <Toolbar className="k-pivot-toolbar k-settings-rows k-pivot-setting" resizable={false} style={{ height: "94px" }}>
                                        <Chip
                                            text="[Geography].[City]"
                                            actions={
                                                <>
                            ...
                            <td>
                                <div className="k-pivot-table">
                                    <Toolbar className="k-pivot-toolbar k-settings-columns k-pivot-setting" resizable={false} style={{ height: "72px" }}>
                                        <Chip
                                            text="[Date].[Calendar]"
                                            actions={
                                                <>
